...
public class PlayerStats : ScriptableObject
{
    ...
    [Range(0.0f, 100.0f)] public float dashKnockbackForce = 40.0f;
    [Range(0.0f, 90.0f)] public float dashKnockbackHeightAngle = 1.0f;
    [Range(0.0f, 100.0f)] public float objectBouceOffForce = 20.0f;
    [Range(0.0f, 90.0f)] public float objectBounceOffAngle = 1.0f;
